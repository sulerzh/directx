namespace Microsoft.Data.Visualization.VisualizationControls.Interop
{
  internal static class Consts
  {
    ...
    internal const string MF_MT_MPEG2_PROFILE = "ad76a80b-2d5c-4e0b-b375-64e520137036";
    ...
    internal const uint MF_SOURCE_READER_MEDIASOURCE = 4294967295U;
    internal const uint MF_SOURCE_READER_ANY_STREAM = 4294967294U;
    internal const uint MF_SOURCE_READER_FIRST_AUDIO_STREAM = 4294967293U;
    internal const uint MF_SOURCE_READER_FIRST_VIDEO_STREAM = 4294967292U;
    internal const uint MF_SOURCE_READER_ALL_STREAMS = 4294967294U;
    internal const uint MF_RESOLUTION_MEDIASOURCE = 1U;
    internal const uint MF_RESOLUTION_BYTESTREAM = 2U;
    internal const uint MF_RESOLUTION_CONTENT_DOES_NOT_HAVE_TO_MATCH_EXTENSION_OR_MIME_TYPE = 16U;
    internal const uint MF_RESOLUTION_KEEP_BYTE_STREAM_ALIVE_ON_FAIL = 32U;
    internal const uint MF_RESOLUTION_READ = 65536U;
    internal const uint MF_RESOLUTION_WRITE = 131072U;
    internal const uint MEError = 1U;
    internal const uint MEExtendedType = 2U;
    internal const uint MENonFatalError = 3U;
    internal const uint MESessionUnknown = 100U;
    internal const uint MESessionTopologySet = 101U;
    internal const uint MESessionTopologiesCleared = 102U;
    internal const uint MESessionStarted = 103U;
    internal const uint MESessionPaused = 104U;
    internal const uint MESessionStopped = 105U;
    internal const uint MESessionClosed = 106U;
    internal const uint MESessionEnded = 107U;
  }
}
