...
{
  [Guid(IID.IMFPresentationDescriptor)]
  ...
  internal interface IMFPresentationDescriptor
  {
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    void GetStreamDescriptorByIndex([In] uint dwIndex, [MarshalAs(UnmanagedType.Bool)] out bool pfSelected, [MarshalAs(UnmanagedType.Interface)] out IMFStreamDescriptor ppDescriptor);
