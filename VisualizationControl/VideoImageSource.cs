...
namespace Microsoft.Data.Visualization.VisualizationControls
{
    internal class VideoImageSource
    {
        ...
        public VideoImageSource(HostControlViewModel model, BitmapData data, Dispatcher dispatcher, double scale)
        {
            ...
            createVideoTaskView.DataContext = model;
            createVideoTaskView.FlowDirection = 
                Thread.CurrentThread.CurrentUICulture.TextInfo.IsRightToLeft ? 
                FlowDirection.RightToLeft : 
                FlowDirection.LeftToRight;
            this.previewControl = createVideoTaskView;
            this.renderTargetBitmap = new RenderTargetBitmap(data.Width, data.Height, Dpi, Dpi, PixelFormats.Pbgra32);
        ...
        public void DoEvents()
        {
            ...
            Dispatcher.CurrentDispatcher.BeginInvoke(DispatcherPriority.Background, task, frame);
