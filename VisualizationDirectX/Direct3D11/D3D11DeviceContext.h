...
ref class VertexShaderPipelineStage;
    ...
    public ref class DeviceContext :
        public Microsoft::Data::Visualization::DirectX::Direct3D11::DeviceChild
    {
    public: 
        ...
        /// <summary>
		/// change rerurn value from void to bool by zsl,2014-11-19
		...
		bool GetData(Asynchronous^ asyncData, IntPtr data, UInt32 dataSize, AsyncGetDataOptions options);
