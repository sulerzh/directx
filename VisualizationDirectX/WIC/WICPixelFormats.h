...
public:
	...
	/// Channel Count = 1, Bits Per Channel = 8,	Bits Per Pixel = 32, Storage Type = uint
	/// </summary>
	static property Guid Alpha8Bpp
	{
		Guid get(void) { return alpha8Bpp; }
	}
...
private:
	...
	static Guid alpha8Bpp = Guid(0xE6CD0116, 0xEEBA, 0x4161, 0xAA, 0x85, 0x27, 0xDD, 0x9F, 0xB3, 0xA8, 0x95);
