...
Microsoft::Data::Visualization::DirectX::Direct3D10::D3DDevice^ DeviceSubObject::AsDirect3D10Device::get(void)
{
    ...
    return tempoutDevice == NULL ? nullptr : gcnew Microsoft::Data::Visualization::DirectX::Direct3D10::D3DDevice(tempoutDevice);
}

Microsoft::Data::Visualization::DirectX::Direct3D10::D3DDevice1^ DeviceSubObject::AsDirect3D10Device1::get(void)
{
    ID3D10Device1* tempoutDevice = NULL;

    Validate::VerifyResult(CastInterface<IDXGIDeviceSubObject>()->GetDevice(__uuidof(tempoutDevice), (void**)&tempoutDevice));

    return tempoutDevice == NULL ? nullptr : gcnew Microsoft::Data::Visualization::DirectX::Direct3D10::D3DDevice1(tempoutDevice);
}
