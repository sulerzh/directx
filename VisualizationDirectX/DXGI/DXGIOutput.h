...
ref class Device;
    ...
    public: 
        ...
        ModeDescription FindClosestMatchingMode(ModeDescription modeToMatch, Microsoft::Data::Visualization::DirectX::Direct3D11::D3DDevice^ concernedDevice);
        ...
        void TakeOwnership(Microsoft::Data::Visualization::DirectX::Direct3D11::D3DDevice^ device, Boolean exclusive);
