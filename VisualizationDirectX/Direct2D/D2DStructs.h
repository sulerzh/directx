...
namespace Microsoft { namespace Data { namespace Visualization { namespace DirectX { namespace Direct2D1 {
    ...
    public:
        ...
        {
            ::Microsoft::Data::Visualization::DirectX::Direct2D1::RenderTargetType get()
            {
                return type;
            }

            void set(::Microsoft::Data::Visualization::DirectX::Direct2D1::RenderTargetType value)
            {
                type = value;
            }
        }
    ...
    private:
        ...
        ::Microsoft::Data::Visualization::DirectX::Direct2D1::RenderTargetType type;
