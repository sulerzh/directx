...
namespace Microsoft { namespace Data { namespace Visualization { namespace DirectX { namespace Graphics {
    ref class Surface;
}}}} }

namespace Microsoft { namespace Data { namespace Visualization { namespace DirectX { namespace DirectWrite {
...
using namespace Microsoft::Data::Visualization::DirectX::DirectWrite;
using namespace Microsoft::Data::Visualization::DirectX::Graphics;

namespace Microsoft { namespace Data { namespace Visualization { namespace DirectX { namespace Direct2D1 {
