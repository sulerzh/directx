...
D3DDevice^ D3DDevice::CreateDevice(Adapter^ adapter, Microsoft::Data::Visualization::DirectX::Direct3D10::DriverType driverType, String^ softwareRasterizerLibrary, Direct3D10::CreateDeviceOptions options)
{
    D3D10CreateDeviceFuncPtr createFuncPtr = 
        (D3D10CreateDeviceFuncPtr) LibraryLoader::Instance()->GetFunctionFromDll(
            D3D10Library, "D3D10CreateDevice");
