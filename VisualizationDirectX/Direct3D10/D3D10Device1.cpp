...
D3DDevice1^ D3DDevice1::CreateDevice1(Adapter^ adapter,  Microsoft::Data::Visualization::DirectX::Direct3D10::DriverType driverType, String^ softwareRasterizerLibrary, Direct3D10::CreateDeviceOptions options, FeatureLevel hardwareLevel)
{
    D3D10CreateDevice1FuncPtr createFuncPtr = 
        (D3D10CreateDevice1FuncPtr) LibraryLoader::Instance()->GetFunctionFromDll(
            D3D10_1Library, "D3D10CreateDevice1");
