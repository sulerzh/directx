...
// Type: Microsoft.Data.Visualization.Engine.OutlineTechnique
...
namespace Microsoft.Data.Visualization.Engine
{
  internal class OutlineTechnique : EffectTechnique
  {
    ...
    protected override void Initialize()
    {
      ...
      {
        VertexShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutline.vs"),
        GeometryShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlineDoubleLine.gs"),
        PixelShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlineDoubleLine.ps"),
        ...
        {
          (IRenderParameter) this.outlineColor,
          (IRenderParameter) this.outlineColor2,
          (IRenderParameter) this.outlineWidth,
          (IRenderParameter) this.outlineOffset,
          (IRenderParameter) this.depthEnabled,
      ...
      {
        VertexShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlineRegion.vs"),
        GeometryShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlineDoubleLineRegion.gs"),
        PixelShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlineDoubleLine.ps"),
      ...
      {
        VertexShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlinePie.vs"),
        GeometryShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlineDoubleLine.gs"),
        PixelShaderData = this.GetType().Assembly.GetManifestResourceStream("Microsoft.Data.Visualization.Engine.Shaders.Compiled.InstancedRenderableOutlineDoubleLine.ps"),
    ...
    protected override void Dispose(bool disposing)
    {
      ...
      DisposableResource[] disposableResourceArray = new DisposableResource[5]
      {
        ...
        (DisposableResource) this.doubleOutline,
        (DisposableResource) this.doubleOutlinePie,
        (DisposableResource) this.doubleOutlineRegion
      };
