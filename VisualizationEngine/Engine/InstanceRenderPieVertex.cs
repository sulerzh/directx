...
// Type: Microsoft.Data.Visualization.Engine.InstanceRenderPieVertex
...
{
  internal struct InstanceRenderPieVertex : IVertex
  {
    public float X;
    public float Y;
    public float Z;
    ...
    public VertexFormat Format
    {
      get
      {
        return VertexFormat.Create(new VertexComponent[5]
        {
